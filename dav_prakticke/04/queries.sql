...
/* 10. How many employees (altogether) are earning between 40% and 60% of the average salary in their department? */
...
/* 12. Find all departments that have at least one employee participating in every big project that exists in the company. A project is considered big if at least 10% of all employees are working on it. */
